...
public class Theme {
    ...
    public static Drawable createSelectorDrawable(int color, int maskType, int radius) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
                ...
                maskDrawable = new Drawable() {
                    ...
                    public void draw(Canvas canvas) {
                        ...
                        if (maskType == 7) {
                            ...
                            rect.set(bounds);
                            canvas.drawRoundRect(rect, InfoUtilities.dp(6), InfoUtilities.dp(6), maskPaint);
                        } else {
                            int rad;
                            if (maskType == 1 || maskType == 6) {
                                rad = InfoUtilities.dp(20);
                            } else if (maskType == 3) {
            ...
            if (Build.VERSION.SDK_INT >= 23) {
                if (maskType == 1) {
                    rippleDrawable.setRadius(radius <= 0 ? InfoUtilities.dp(20) : radius);
                } else if (maskType == 5) {
    ...
    public static void createCommonResources(Context context){
        ...
        checkboxSquare_checkPaint.setStrokeWidth(InfoUtilities.dp(2));

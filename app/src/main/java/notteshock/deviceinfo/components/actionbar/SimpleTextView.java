...
public class SimpleTextView extends View implements Drawable.Callback {
    ...
    private int drawablePadding = InfoUtilities.dp(4);
    ...
    public void setTextSize(int size) {
        int newSize = InfoUtilities.dp(size);
        ...
        if (text != null) {
            try {
                ...
                layout = new StaticLayout(string, 0, string.length(), textPaint,
                        width + InfoUtilities.dp(8), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f,
                        false);

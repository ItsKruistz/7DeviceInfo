...
import notteshock.deviceinfo.components.AnimatorListenerAdapterProxy;
import notteshock.deviceinfo.components.LayoutHelper;
...
public class ActionBar extends FrameLayout {
    ...
    public static int getCurrentActionBarHeight() {
        if (InfoUtilities.isTablet()) {
            return InfoUtilities.dp(64);
        } else if (InfoApplication.applicationContext.getResources()
                .getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE) {
            return InfoUtilities.dp(48);
        } else {
            return InfoUtilities.dp(48);
        }
    }
    ...
    private void createBackButtonImage() {
        ...
        params.setMargins(InfoUtilities.dp(8), 0, 0, 0);
    ...
    public ActionBarMenu createMenu() {
        ...
        screenSize = InfoUtilities.getRealScreenSize();
    ...
    public ActionBarMenu createActionMode() {
        ...
        actionMode.setPadding(0, occupyStatusBar ? InfoUtilities.statusBarHeight : 0, 0, 0);
        ...
        if (occupyStatusBar && actionModeTop == null) {
            ...
            layoutParams.height = InfoUtilities.statusBarHeight;
            layoutParams.width = LayoutHelper.MATCH_PARENT;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int actionBarHeight = getCurrentActionBarHeight() + InfoUtilities.dp(6);
        int actionBarHeightSpec = MeasureSpec.makeMeasureSpec(actionBarHeight, MeasureSpec.EXACTLY);

        setMeasuredDimension(width, actionBarHeight
                + (occupyStatusBar ? InfoUtilities.statusBarHeight : 0) + extraHeight);

        int textLeft;
        if (backContainer != null && backContainer.getVisibility() != GONE) {
            backContainer.measure(
                    MeasureSpec.makeMeasureSpec(InfoUtilities.dp(72), MeasureSpec.EXACTLY),
                    actionBarHeightSpec);
            textLeft = InfoUtilities.dp(InfoUtilities.isTablet() ? 80 : 72);
        } else {
            textLeft = InfoUtilities.dp(InfoUtilities.isTablet() ? 26 : 18);
        }
        ...
        if (menu != null && menu.getVisibility() != GONE) {
            ...
            if (isSearchFieldVisible) {
                menuWidth = MeasureSpec.makeMeasureSpec(
                        width - InfoUtilities.dp(InfoUtilities.isTablet() ? 74 : 66),
                        MeasureSpec.EXACTLY);
            } else {
        ...
        if (titleTextView != null && titleTextView.getVisibility() != GONE
            ...
            int availableWidth = width - (menu != null ? menu.getMeasuredWidth() : 0)
                    - InfoUtilities.dp(16) - textLeft;

            if (titleTextView != null && titleTextView.getVisibility() != GONE) {
                titleTextView.setTextSize(!InfoUtilities.isTablet() && getResources()
                        .getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE ? 18
                        : 20);
                titleTextView.measure(
                        MeasureSpec.makeMeasureSpec(availableWidth, MeasureSpec.AT_MOST),
                        MeasureSpec.makeMeasureSpec(InfoUtilities.dp(24), MeasureSpec.AT_MOST));

            }
            if (subtitleTextView != null && subtitleTextView.getVisibility() != GONE) {
                subtitleTextView.setTextSize(!InfoUtilities.isTablet() && getResources()
                        .getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE ? 14
                        : 16);
                subtitleTextView.measure(
                        MeasureSpec.makeMeasureSpec(availableWidth, MeasureSpec.AT_MOST),
                        MeasureSpec.makeMeasureSpec(InfoUtilities.dp(20), MeasureSpec.AT_MOST));
            }
        }
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        int additionalTop = (occupyStatusBar ? InfoUtilities.statusBarHeight : 0); // InfoUtilities.dp(6);
        //    int additionalTop= 0 ;
        ...
        if (menu != null && menu.getVisibility() != GONE) {
            int menuLeft = isSearchFieldVisible
                    ? InfoUtilities.dp(InfoUtilities.isTablet() ? 74 : 66)
        ...
        if (titleTextView != null && titleTextView.getVisibility() != GONE) {
            ...
            if (subtitleTextView != null && subtitleTextView.getVisibility() != GONE) {
                textTop = (getCurrentActionBarHeight() / 2 - titleTextView.getTextHeight()) / 2
                        + InfoUtilities.dp(!InfoUtilities.isTablet() && getResources()
                        .getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE
                        ? 2 : 3);
            } else {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            //标题居中
            if (screenSize == null) screenSize = InfoUtilities.getRealScreenSize();
